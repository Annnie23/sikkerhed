        ...
        <div class="overlay">
            <div class="content-container">
                ...
                <div class="right-side">
                    <h2><?php echo esc_html(get_field('new_section_header2')); ?></h2>
...
<div class="link-section-2">
        ...
        <a href="http://sikkerhedunderskydning.local/quiz/" class="button2" id="link_knap_2">Tag testen om skydesikkerhed her</a>
</div>
